...
Plans:
- [x] 07-01-PLAN.md — Migrate adapter-static to adapter-vercel (server runtime prerequisite)
- [x] 07-02-PLAN.md — Backend auth: verify-auth-token.ts + preHandler on POST /executions
- [x] 07-03-PLAN.md — Auth.js core setup: @auth/sveltekit, auth.ts, hooks.server.ts, catch-all route
- [x] 07-04-PLAN.md — Login page (/login) + root layout session loader + nav user display
- [x] 07-05-PLAN.md — /new-execution auth guard + form action with Bearer token forwarding
- [x] 07-06-PLAN.md — Human verification: end-to-end auth gate flows
