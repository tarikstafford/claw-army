...
vi.mock('@claw/db', () => ({
  db: mockDb,
  executions: { id: Symbol('executions.id'), objective: Symbol('executions.objective'), status: Symbol('executions.status'), createdAt: Symbol('executions.createdAt'), projectId: Symbol('executions.projectId') },
